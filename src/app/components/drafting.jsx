...
const Drafting = () => {
  ...
  return (
    <div className="drafting self-stretch flex-1 rounded-lg bg-mediumseagreen-200 shadow-hieroshadow-35 border-seagreen border-x border-b border-b-lg border-solid flex flex-col items-center justify-start">
      ...
      <div
        className="w-full h-full flex flex-col items-center justify-between p-3 pr-2 gap-4"
        style={{ height: "calc(100% - 33px)" }}
      >
        <div className="drafting-scrollable w-full flex flex-col items-center justify-between gap-2 pr-3 overflow-y-scroll">
          {renderContent()}
        </div>
        <MessageForm />
      </div>
