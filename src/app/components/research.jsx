...
const Research = () => {
  ...
  return (
    <div className="self-stretch flex-1 rounded-lg bg-darkorchid-200 shadow-hieroshadow-35 border-researchpurple/70 border-[1px] border-solid flex flex-col items-center justify-start gap-[1.5rem] text-white">
