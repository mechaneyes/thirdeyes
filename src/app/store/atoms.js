...
export const researchLyricalAnalysisAtom = atom(undefined);
export const researchLyricalAnalysisProgressAtom = atom(false);
export const researchNewsAtom = atom(undefined);
export const researchNewsProgressAtom = atom(false);
export const researchSonicAnalysisAtom = atom(undefined);
