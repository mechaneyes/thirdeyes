...
export default function Home() {
  return (
    <div className="thirdeyes w-full flex flex-col items-center justify-center p-0 pb-4 overflow-hidden">
      <Header />
      <div className="third-body grid grid-rows-12 gap-4" style={{ height: 'calc(100vh - 76px)' }}>
