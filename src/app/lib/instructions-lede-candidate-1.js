...
11. At the bottom of your output list any information you've leveraged from the provided context, wrapping it in in <ul class='reflection__context'><li></li> tags. Prepend this list with the phrase, <p class='reflection__context'>Information sourced from Wikipdia:</p>.
...
Start by specifying the artist’s primary genre(s).

Specify the Timeframe:
Indicate the period when the artist was most influential or prominent.

Describe the Sound and Style:
Outline the artist’s signature sound and style, focusing on what sets them apart from other artists.

Highlight Unique Elements:
Emphasize the distinctive characteristics of the artist’s music that make them stand out.

Connect to Musical Movements:
Relate the artist’s work to the major musical movements of their era.

Position within the Era:
Explain how the artist fits into the broader musical landscape of their time, including their contributions and influence.

Assess Impact:
Briefly discuss the artist's role and significance within their genre and era.


Following is text wrapped in triple quotes. Rewrite that text using the guidelines above. 

This is the text to rewrite:
`